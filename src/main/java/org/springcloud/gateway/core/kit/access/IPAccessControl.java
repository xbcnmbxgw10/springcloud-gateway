 ...
 */
package org.springcloud.gateway.core.kit.access;
...
public class IPAccessControl {
    ...
    /*
     * Copyright 1999-2101 springcloudgateway Group Holding Ltd.
     *
    ...
    public static class IPAccessProperties implements InitializingBean {
         ...
         * variables. e.g. spring.commonsiam.acl.denyIpRange:
         * ${DEVOPS_IAM_ACL_DENY}
         * 
         * @param range
         * @return
