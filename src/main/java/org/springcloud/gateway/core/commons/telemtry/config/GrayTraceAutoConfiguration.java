...
import org.springcloud.gateway.core.commons.telemtry.GrayTraceWebFilter;
...
public class GrayTraceAutoConfiguration {
    ...
    static class TraceOtelHttpBridgeConfiguration {
        ...
        SamplerFunction<HttpRequest> defaultTraceHttpClientSampler(SleuthWebProperties sleuthWebProperties) {
