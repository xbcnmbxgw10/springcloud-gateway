 ...
 */
@Slf4j
public class ResponseGlobalFilter extends EntrypointBaseGlobalFilter {

    public ResponseGlobalFilter(LoggingProperties loggingConfig) {
        super(loggingConfig);
    }
